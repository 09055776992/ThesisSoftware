...
const providerDetailsArb = fc.oneof(
  ...
  // Partial sub-documents — some fields present, some absent
  fc.record({
    organizationName: optionalStringArb,
  }),
  fc.record({
    ...
    async () => {
      ...
      const allAbsentArb = fc.record({
        ...
        providerDetails: fc.oneof(
          ...
          fc.constant(undefined),
          fc.record({
            organizationName: fc.oneof(fc.constant(null), fc.constant(undefined), fc.constant("")),
            position: fc.oneof(fc.constant(null), fc.constant(undefined), fc.constant("")),
            phone: fc.oneof(fc.constant(null), fc.constant(undefined), fc.constant("")),
            officeAddress: fc.oneof(fc.constant(null), fc.constant(undefined), fc.constant("")),
            description: fc.oneof(fc.constant(null), fc.constant(undefined), fc.constant("")),
            website: fc.oneof(fc.constant(null), fc.constant(undefined), fc.constant("")),
          })
        ),
        profilePicture: fc.oneof(fc.constant(null), fc.constant(undefined), fc.constant("")),
      });
