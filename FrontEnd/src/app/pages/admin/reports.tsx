    ...
    <div className="p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-8 text-center">
          <h2 className="text-xl font-semibold text-gray-900 mb-2">Detailed Reports</h2>
          <p className="text-gray-600 mb-6">
            Export comprehensive analytics and generate custom reports
          </p>
          <button className="px-6 py-2.5 bg-[#1E3A5F] text-white rounded-lg font-medium hover:bg-[#152e4a]">
            Generate Report
          </button>
        </div>
      </div>
